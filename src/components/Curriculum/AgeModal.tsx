...
const AgeCategoryCard = memo(
  ({ category, index, isSelected, onSelect, locale, animateIn }: AgeCategoryCardProps) => {
    const getDisplayAgeRange = useCallback(
    ...
    return (
      <button
        ...
        className={`group p-4 text-left border rounded-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden ${
          isSelected
...
const AgeModal = ({ onAgeSelect, categories = [] }: AgeModalProps) => {
  ...
  return (
    ...
    >
      {/* Modal */}
      <div
        className={`relative bg-white dark:bg-darkmode rounded-2xl shadow-xl max-w-2xl w-full mx-auto border border-PowderBlueBorder dark:border-dark_border 
        max-h-[85vh] flex flex-col transform transition-all duration-300 ${
          animateIn
      ...
      >
        {/* Header (fixed) */}
        <div className="p-6 border-b border-PowderBlueBorder/50 dark:border-dark_border bg-gradient-to-r from-primary to-ElectricAqua text-white rounded-t-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/90 text-sm">
                  {t('curriculum.chooseAgeGroup') ||
                    'Choose the perfect starting point'}
                </p>
              </div>
            </div>
        ...
        <div className="p-6 overflow-y-auto flex-1">
          <div className="text-center mb-6">
            <p className="text-SlateBlueText dark:text-darktext text-sm max-w-md mx-auto">
              {t('curriculum.selectAgeDescription') ||
