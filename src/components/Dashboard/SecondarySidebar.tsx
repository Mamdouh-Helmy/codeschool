...
const SecondarySidebar = ({
    ...
    return (
        <>
            <div
                className={`fixed inset-y-0 ${isRTL ? 'right-0' : 'left-0'} z-50 w-72 transform border-r border-slate-200 bg-white transition-all duration-300 ease-in-out dark:border-dark_border dark:bg-darklight lg:fixed lg:${isRTL ? 'right-0' : 'left-0'} lg:z-30 lg:mt-0 ${isMobile
                    ? isOpen ? "translate-x-0" : (isRTL ? "translate-x-full" : "-translate-x-full")
                    : isOpen ? (isRTL ? "lg:-translate-x-72" : "lg:translate-x-72") : "lg:translate-x-0"
