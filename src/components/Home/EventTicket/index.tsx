      ...
      <section className="dark:bg-darkmode pt-0">
        ...
        <div className="container">
          ...
          <div className="flex flex-wrap items-stretch" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
            ...
            <div className="bg-ElectricAqua lg:py-14 py-6 lg:px-10 px-4 lg:rounded-r-22 rounded-b-22 md:rounded-bl-none md:rounded-tr-22 rounded-tr-none md:w-2/4 w-full">
                ...
                <div className="space-y-4">
                  {loading ? (
                    ...
                    plans.map((plan) => {
                      ...
                      return (
                        <div key={plan._id} className="flex items-center md:gap-10 gap-2">
