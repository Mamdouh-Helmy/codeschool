        ...
        <div className="container">
            <div className="">
                <div className="grid lg:grid-cols-9 md:grid-cols-6 grid-cols-1 xl:gap-30 gap-0 border-b border-solid border-white border-opacity-50 pb-11 dark:border-dark_border">
                    ...
                    <div className="col-span-3">
                        <Link href="mailto:headoffice@CodeSchool.online" className="sm:text-2xl text-xl text-secondary dark:text-SereneSky font-medium underline hover:dark:text-white hover:text-RegalBlue">headoffice@Codeschool.online</Link>
                ...
                <div className="grid lg:grid-cols-9 md:grid-cols-6 grid-cols-1 gap-30 pt-12">
                    ...
                    <div className="col-span-3">
                        <Link href="mailto:Office@Codeschool.online" className="sm:text-2xl text-xl text-secondary dark:text-SereneSky font-medium underline hover:dark:text-white hover:text-RegalBlue">Office@Codeschool.online</Link>
