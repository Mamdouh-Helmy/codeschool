              ...
              <form className="flex flex-wrap w-full m-auto justify-between">
                <div className="sm:flex gap-3 w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="first-name" className="pb-3 inline-block text-base text-SlateBlueText">{t('contact.firstName') || 'First Name*'}</label>
                    <input
                      id="first-name"
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="last-name" className="pb-3 inline-block text-base text-SlateBlueText">{t('contact.lastName') || 'Last Name*'}</label>
                    <input
                      id="last-name"
                ...
                <div className="sm:flex gap-3 w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="email" className="pb-3 inline-block text-base text-SlateBlueText">{t('contact.email') || 'Email address*'}</label>
                    <input
                      id="email"
                      type="email"
                      className="w-full text-base px-4 py-2.5 rounded-lg border-border dark:border-dark_border border-solid dark:text-white  dark:bg-darkmode border transition-all duration-500 focus:border-primary dark:focus:border-primary focus:border-solid focus:outline-0"
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="Specialist" className="pb-3 inline-block text-base text-SlateBlueText">{t('contact.specialist') || 'Specialist*'}</label>
                ...
                <div className="sm:flex gap-3 w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="date" className="pb-3 inline-block text-base text-SlateBlueText">{t('contact.date') || 'Date*'}</label>
                    <input
                      id="date"
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="time" className="pb-3 inline-block text-base text-SlateBlueText">{t('contact.time') || 'Time*'}</label>
                    <input
                      id="time"
                ...
                <div className="mx-0 my-2.5 w-full">
                  <Link href="#" className="mt-4 btn btn-1 hover-filled-slide-down overflow-hidden rounded-lg" type="submit">
                    <span>{t('contact.makeAppointment') || 'Make an appointment'}</span>
                  </Link>
                </div>
              </form>
            </div>
