      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
        <div className="grid md:grid-cols-12 grid-cols-1 gap-8">
          <div className="col-span-6">
            ...
            <p className="text-xl text-SlateBlueText dark:text-primary mb-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-wrap w-full m-auto justify-between">
              <div className="sm:flex gap-3 w-full">
                <div className="mx-0 my-2.5 flex-1">
                  <label htmlFor="firstName" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
                ...
                <div className="mx-0 my-2.5 flex-1">
                  <label htmlFor="lastName" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
              ...
              <div className="sm:flex gap-3 w-full">
                <div className="mx-0 my-2.5 flex-1">
                  <label htmlFor="email" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
                ...
                <div className="mx-0 my-2.5 flex-1">
                  <label htmlFor="specialist" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
              ...
              <div className="sm:flex gap-3 w-full">
                <div className="mx-0 my-2.5 flex-1">
                  <label htmlFor="date" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
                    {t('contact.date') || 'Date*'}
                  </label>
                  <input
                    id="date"
                ...
                <div className="mx-0 my-2.5 flex-1">
                  <label htmlFor="time" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
                    {t('contact.time') || 'Time*'}
                  </label>
                  <input
                    id="time"
              ...
              <div className="mx-0 my-2.5 w-full">
                <label htmlFor="message" className="pb-3 inline-block text-base text-SlateBlueText dark:text-primary">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full text-base px-4 py-2.5 rounded-lg border-border dark:border-dark_border border-solid dark:text-primary dark:bg-darkmode border transition-all duration-500 focus:border-primary dark:focus:border-primary focus:border-solid focus:outline-0"
              ...
              <div className="mx-0 my-2.5 w-full">
                <button
                  type="submit"
                  disabled={loading}
                  className="mt-4 bg-primary hover:bg-primary/90  text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ?
