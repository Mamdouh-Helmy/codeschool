            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className="text-SlateBlueText dark:text-primary font-normal text-xl max-w-80 pt-3 pb-7 dark:text-opacity-80">
                ...
                <div>
                  <Link
                    ...
                    className="text-primary text-lg font-medium flex items-center gap-3 group hover:text-secondary dark:hover:text-white transition-colors duration-300"
                  >
                    ...
                    <svg
                      ...
                      className="group-hover:fill-secondary group-hover:dark:fill-white transition-colors duration-300"
                    >
                      <path
