...
const en = {
  ...
  "group.instructor.lastInstructorWarning":
    "Warning: This is the last remaining instructor",
  // Common
  ...
  "dashboard.progressMessage":
    "You're making great progress! Keep up the momentum and achieve your goals.",
  "dashboard.browseCourses": "Browse Courses",
  "dashboard.quickStart": "Quick Start",
  "dashboard.attended": "Attended",
  "dashboard.absent": "Absent",
  "dashboard.late": "Late",
  "dashboard.attendedSessions": "Attended Sessions",
  "dashboard.absentSessions": "Absent Sessions",
  "dashboard.lateSessions": "Late Sessions",
  ...
  "dashboard.trackJourney": "Track your journey to success",
  ...
  "dashboard.meetingLinkSoon": "Meeting link will be available soon",
  ...
  "guests.loadError": "Failed to load guests",
  "guests.createdSuccess": "Guest created successfully",
  "guests.savedSuccess": "Changes saved successfully",
  "guests.management": "Guest Management",
  "guests.managementDescription":
    "Manage guests, organize their information, and track their activities",
  "guests.addNew": "Add Guest",
  "guests.stats.total": "Total",
  "guests.stats.active": "Active",
  "guests.stats.inactive": "Inactive",
  "guests.stats.byProvider": "Registration Source",
  "guests.filters": "Filters",
  "guests.searchPlaceholder": "Search by name / email / username...",
  "guests.filterAllProviders": "All Registration Sources",
  "guests.filterAllStatus": "All Statuses",
  "guests.active": "Active",
  "guests.inactive": "Inactive",
  "guests.filterAllLanguages": "All Languages",
  "guests.refresh": "Refresh",
  "guests.table.guest": "User",
  "guests.table.provider": "Provider",
  "guests.table.language": "Language",
  "guests.table.username": "Username",
  "guests.table.contact": "Contact",
  "guests.table.joined": "Joined",
  "guests.table.status": "Status",
  "guests.table.actions": "Actions",
  "guests.table.noPhone": "None",
  "guests.toggleStatus": "Click to toggle status",
  "guests.noGuests": "No guests yet",
  "guests.noMatchingResults": "No matching results",
  "guests.noGuestsDescription":
    "New accounts will appear here automatically, or add one manually.",
  "guests.addFirst": "Add First Guest",
  "guests.pagination.showing": "Showing",
  "guests.pagination.to": "to",
  "guests.pagination.of": "of",
  "guests.pagination.guests": "guests",
  "guests.pagination.page": "Page",
  "guests.activated": "Account activated",
  "guests.deactivated": "Account deactivated",
  "guests.updateFailed": "Failed to update status",
  "guests.updateError": "An error occurred while updating",
  "guests.deleteConfirm": "Are you sure you want to delete",
  "guests.deletedSuccess": "Guest deleted successfully",
  "guests.deleteFailed": "Failed to delete",
  "guests.deleteError": "An error occurred while deleting",

  "guestForm.addGuest": "Add New Guest",
  "guestForm.updateGuest": "Edit Guest Details",
  "guestForm.viewGuest": "Guest Details",
  "guestForm.nameRequired": "Name is required",
  "guestForm.emailRequired": "Email is required",
  "guestForm.passwordRequired": "Password is required",
  "guestForm.passwordMismatch": "Passwords do not match",
  "guestForm.passwordTooShort": "Password must be at least 6 characters",
  "guestForm.creating": "Creating...",
  "guestForm.updating": "Saving...",
  "guestForm.createFailed": "Failed to create guest",
  "guestForm.updateFailed": "Failed to update guest",
  "guestForm.createdSuccess": "Guest created successfully",
  "guestForm.updatedSuccess": "Changes saved successfully",
  "guestForm.updateError": "An error occurred while saving",
  "guestForm.basicInfo": "Basic Information",
  "guestForm.basicInfoDescription": "Account basic details",
  "guestForm.name": "Name",
  "guestForm.gender": "Gender",
  "guestForm.language": "Language",
  "guestForm.email": "Email",
  "guestForm.emailReadOnly": "Email cannot be changed after creation",
  "guestForm.username": "Username",
  "guestForm.usernameHint":
    "If left empty, it will be auto-generated from the name",
  "guestForm.phone": "Phone",
  "guestForm.isActive": "Account Active",
  "guestForm.imageUrl": "Profile Image",
  "guestForm.uploading": "Uploading...",
  "guestForm.changeImage": "Change Image",
  "guestForm.uploadImage": "Upload Image",
  "guestForm.removeImage": "Remove",
  "guestForm.imageRequirements":
    "Max size: 5MB • JPEG, PNG, WebP — default avatar used if none",
  "guestForm.setPassword": "Password",
  "guestForm.password": "Password",
  "guestForm.confirmPassword": "Confirm Password",
  "guestForm.minChars": "At least 6 characters",
  "guestForm.roleTitle": "Role / Promotion",
  "guestForm.roleDescription":
    "Change the account role from Guest to Student or Instructor",
  "guestForm.instructorPromotionNote":
    "Will automatically generate: username (if missing), QR code, and default portfolio — same as creating a new Instructor.",
  "guestForm.saveChanges": "Save Changes",
  "guestForm.create": "Create Guest",
  "common.guest": "Guest",
  "common.user": "User",
  "userForm.nameRequired": "Name is required",
  "userForm.passwordMismatch": "Passwords do not match",
  "userForm.passwordTooShort": "Password must be at least 6 characters",
  "userForm.updating": "Saving...",
  "userForm.updateFailed": "Failed to save",
  "userForm.updatedSuccess": "Saved successfully",
  "userForm.updateError": "An error occurred while saving",
  "userForm.basicInfo": "Basic Information",
  "userForm.basicInfoDescription": "Basic account details",
  "userForm.name": "Name",
  ...
  "userForm.isActive": "Account Active",
  "userForm.imageUrl": "Profile Image",
  "userForm.uploading": "Uploading...",
  "userForm.changeImage": "Change Image",
  "userForm.uploadImage": "Upload Image",
  "userForm.removeImage": "Remove",
  "userForm.imageRequirements":
    "Max size: 5MB • JPEG, PNG, WebP — default avatar used if none",
  "userForm.roleAndSecurity": "Role & Security",
  "userForm.roleDescription": "Change account role or reset password",
  "userForm.role": "Role",
  "userForm.instructorPromotionNote":
    "Will automatically generate: username (if missing), QR code, and default portfolio — same as creating a new Instructor.",
  "userForm.newPassword": "New Password",
  "userForm.confirmPassword": "Confirm Password",
  "userForm.portfolioDetails": "Portfolio Details",
  "userForm.noPortfolio": "No portfolio",
  "userForm.views": "Views",
  "userForm.skills": "Skills",
  "userForm.projects": "Projects",
  "userForm.certificates": "Certificates",
  "userForm.viewPortfolio": "View Portfolio",
  "userForm.noPortfolioYet":
    "No portfolio yet — it will be auto‑generated once changes are saved",
  "userForm.recentNotifications": "Recent Notifications",
  "userForm.recentNotificationsDescription":
    "Last 5 WhatsApp messages sent to this account",
  "userForm.sent": "Sent",
  "userForm.failed": "Failed",
  "userForm.noNotifications": "No notifications recorded",
  "userForm.saveChanges": "Save Changes",
  "userForm.manageUser": "Manage User Data",

  "users.loadError": "Failed to load users",
  "users.savedSuccess": "Changes saved successfully",
  "users.activated": "Account activated",
  "users.deactivated": "Account deactivated",
  "users.updateFailed": "Failed to update status",
  "users.updateError": "An error occurred while updating",
  "users.deleteConfirm": "Are you sure you want to delete",
  "users.deletedSuccess": "User deleted",
  "users.deleteFailed": "Failed to delete",
  "users.deleteError": "An error occurred while deleting",
  "users.management": "All Users",
  "users.managementDescription":
    "All accounts on the platform with all roles — edit and delete only",
  "users.stats.total": "Total",
  "users.stats.active": "Active",
  "users.stats.inactive": "Inactive",
  "users.stats.byRole": "By Role",
  "users.allRoles": "All",
  "users.filters": "Filters",
  "users.searchPlaceholder": "Search by name / email / username...",
  "users.filterAllProviders": "All sign‑up providers",
  "users.filterAllStatus": "All statuses",
  "users.active": "Active",
  "users.inactive": "Inactive",
  "users.filterAllLanguages": "All languages",
  ...
  "users.table.noPhone": "None",
  "users.toggleStatus": "Click to toggle status",
  "users.noUsers": "No matching users",
  "users.noMatchingResults": "Try changing the filter or search",
  "users.pagination.showing": "Showing",
  "users.pagination.to": "to",
